                                                ...
                                                <div class="item-info horizontal-start vertical-middle">
                                                    <div class="content">
                                                        ...
                                                        <a class="button-slider button button-white button-outline thick-border"
                                                            href="?act=danhsachsanpham">Khám phá ngay</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="bg-banner">
                                                        <div class="banner-wrapper banners">
                                                            <div class="banner-image">
                                                                <a href="?act=danhsachsanpham">
                                                                    <img width="630" height="457"
                                                                        src="media/banner/banner-12-1.jpg"
                                                                        alt="Banner Image">
                                                                </a>
                                                            </div>
                                                            <div class="banner-wrapper-infor">
                                                                <div class="info">
                                                                    <div class="content">
                                                                        <h3 class="title-banner" style="color: white;">
                                                                            Sản phẩm mới</h3>
                                                                        <a class="button" href="?act=danhsachsanpham"
                                                            ...
                                                            <div class="banner-image">
                                                                <a href="?act=danhsachsanpham">
                                                                    <img width="450" height="457"
                                                                        src="media/banner/banner-1-222.jpg"
                                                                        alt="Banner Image">
                                                                </a>
                                                            </div>
                                                                ...
                                                                <div class="info">
                                                                    <div class="content">
                                                                        ...
                                                                        <a class="button center"
                                                                            href="?act=danhsachsanpham">Mua ngay</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="bg-banner">
                                                        <div class="banner-wrapper banners">
                                                            <div class="banner-image">
                                                                <a href="?act=danhsachsanpham">
                                                                    <img width="630" height="457"
                                                                        src="media/banner/banner-1-333.jpg"
                                                                        alt="Banner Image">
                                                                </a>
                                                            </div>
                                                            <div class="banner-wrapper-infor">
                                                                    ...
                                                                    <div class="products-thumb">
                                                                        ...
                                                                        <div class="product-thumb-hover">
                                                                            <a
                                                                                ...
                                                                                <img width="600" height="600"
                                                                                    src="<?= 'http://localhost/web_Tshirt/' . $sanPham['img'] ?>"
                                                                        ...
                                                                        <div class="product-button">
                                                                            ...
                                                                            <div class="btn-wishlist" data-title="Wishlist">
                                                                                <button class="product-btn">Thêm vào yêu
                                                                                    thích</button>
                                                                            </div>
                                                                    ...
                                                                    <div class="products-content">
                                                                        <div class="contents">
                                                                            ...
                                                                            <h3 class="product-title"><a
                                                                                    href="shop-details.html"><?= $sanPham['ten'] ?></a>
                                                                            </h3>
                                                                            <span
                                                                                class="price"><?= $sanPham['gia_ban'] ?></span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                ...
                                <div class="row">
                                    <div class="section-column left">
                                        <div class="intro-wrap">
                                            <h2 class="intro-title">Được may thủ công<br> &amp; mang đậm tinh thần đường phố</h2>
                                            <div class="intro-item">
                                                <div class="icon">
                                                <span class="wrap animation-horizontal">
    <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 64 64" fill="currentColor">
        <path d="M20 2l-6 4-8 2v10l10 4v40h12V32h8v30h12V22l10-4V8l-8-2-6-4-6 6h-12l-6-6z"/>
    </svg>
</span>
                                                            <g>
                                                                <g>
                                            ...
                                            <div class="intro-item">
                                                <div class="icon">
                                                    ...
                                                    <path d="M16.5 3l2.7 2.1 2.8.9-.9 4.4L18 9v12h-5v-7h-2v7H6V9l-3.1 1.4-.9-4.4 2.8-.9L8.5 3l3 3h1l3-3z"/>
                                                            <g>
                                                                <g>
                                                                    <path
                                            ...
                                            <div class="intro-btn">
                                                <a href="?act=danhsachsanpham"
                                                    class="button button-black button-arrow animation-horizontal">Tìm
                                                    hiểu thêm</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="section-column right">
                                        <a href="#">
                                            <img class="hover-opacity" width="820" height="674"
                                                src="media/banner/intro-12.jpg" alt="intro">
                                        </a>
                                    </div>
                                </div>
                            </div>
                                                                    ...
                                                                    <div class="products-thumb">
                                                                        ...
                                                                        <div class="product-thumb-hover">
                                                                            <a href="?act=tin-tuc&id=<?= $tintuc['id'] ?>">
                                                                                <img width="600" height="600"
                                                                                    src="<?= 'http://localhost/web_Tshirt/admin/' . $tintuc['img'] ?>"
                                                                                    class="post-image" alt="">
                                                                                <img width="600" height="600"
                                                                                    src="<?= 'http://localhost/web_Tshirt/admin/' . $tintuc['img'] ?>"
                                                                                    class="hover-image back" alt="">
                                                                    ...
                                                                    <div class="products-content">
                                                                        <div class="contents">
                                                                            ...
                                                                            <h2 class="product-title"><a
                                                                                    href="?act=tin-tuc&id=<?= $tintuc['id'] ?>"><?= $tintuc['title'] ?></a>
                                                                            </h2>
                                                            ...
                                                            <div class="banner-image">
                                                                <a href="?act=danhsachsanpham">
                                                                    <img width="856" height="496"
                                                                        src="media/banner/banner-1-444.jpg"
                                                                        alt="Banner Image">
                                                                </a>
                                                            </div>
                                                            <div class="banner-wrapper-infor">
                                                                <div class="info">
                                                                    <div class="content">
                                                                        ...
                                                                        <a class="button button-outline thick-border border-white button-arrow"
                                                                            href="?act=danhsachsanpham">Khám phá</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="bg-banner">
                                                        <div class="banner-wrapper banners">
                                                            <div class="banner-image">
                                                                <a href="?act=danhsachsanpham">
                                                                    <img width="856" height="496"
                                                                        src="media/banner/banner-1-555.jpg"
                                                                        alt="Banner Image">
                                                                </a>
                                                            </div>
                                                            <div class="banner-wrapper-infor">
                                                                <div class="info">
                                                                    <div class="content">
                                                                        <h3 class="title-banner"> Làm cho nó đáng nhớ
                                                                        </h3>
                                                    ...
                                                    <div class="testimonial-content">
                                                        <div class="item">
                                                            <div class="testimonial-item">
                                                                ...
                                                                <h2 class="testimonial-title">“Những bình luận tuyệt
                                                                    vời”</h2>
                                                                <div class="testimonial-excerpt">
                                                                    Trang web có thiết kế tinh tế, phù hợp với sản phẩm
                                                                    nhẫn. </div>
                                                            </div>
                                                            <div class="testimonial-image image-position-top">
                                                                <div class="thumbnail">
                                                                    <img width="110" height="110"
                                                                        src="media/testimonial/5.jpg" alt="">
                                                                </div>
                                                                <div class="testimonial-info">
                                                                    <h2 class="testimonial-customer-name">Đàm Đức Thịnh
                                                                    </h2>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="testimonial-content">
                                                        <div class="item">
                                                            <div class="testimonial-item">
                                                                ...
                                                                <div class="testimonial-excerpt">
                                                                    Nhẫn được trình bày với hình ảnh rõ nét, hấp dẫn.
                                                                </div>
                                                            </div>
                                                            <div class="testimonial-image image-position-top">
                                                                <div class="thumbnail">
                                                                    <img width="110" height="110"
                                                                        src="media/testimonial/6.jpg" alt="">
                                                                </div>
                                                                <div class="testimonial-info">
                                                                    <h2 class="testimonial-customer-name">Nguyễn Tuấn
                                                                        Anh</h2>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="testimonial-content">
                                                        <div class="item">
                                                            <div class="testimonial-item">
                                                                ...
                                                                <h2 class="testimonial-title">“Chính sách minh bạch1”
                                                                </h2>
                                                                <div class="testimonial-excerpt">
                                                                    Chính sách đổi trả và bảo hành rõ ràng, tạo sự tin
                                                                    tưởng. </div>
                                                            </div>
                                                            <div class="testimonial-image image-position-top">
                                                                <div class="thumbnail">
                                                                    <img width="110" height="110"
                                                                        src="media/testimonial/7.jpg" alt="">
                                                                </div>
                                                                <div class="testimonial-info">
                                                                    <h2 class="testimonial-customer-name">Đặng Thanh Hà
                                                                    </h2>
                                                                </div>
                                                            </div>
                                                        </div>
                                ...
                                <div class="block block-newsletter layout-2 one-col">
                                    <div class="block-widget-wrap">
                                        <div class="newsletter-title-wrap">
                                            <h2 class="newsletter-title">Tin Mới Nhất Từ T-Shirt!</h2>
                                            <div class="newsletter-text">Đăng ký để được giảm giá 10% cho lần mua hàng
                                                tiếp theo của bạn.</div>
                                        </div>
